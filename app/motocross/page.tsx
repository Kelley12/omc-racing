  ...
  return (
    <>
      ...
      <Box sx={{ py: { xs: 6, md: 10 }, background: 'linear-gradient(135deg, #0A0A0A 0%, #1A1A1A 100%)', borderBottom: '2px solid', borderColor: 'primary.main', position: 'relative', overflow: 'hidden',
        '&::before': { content: '""', position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 80% 50%, rgba(255,102,0,0.08) 0%, transparent 60%)', pointerEvents: 'none' } }}>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={6} sx={{ alignItems: 'flex-start' }}>
            ...
            <Grid size={{ xs: 12, md: 5 }}>
              <Card sx={{ border: '1px solid rgba(255,102,0,0.2)' }}>
                <CardContent sx={{ p: 4 }}>
              ...
              <Card sx={{ mt: 3, border: '1px solid rgba(255,255,255,0.08)', backgroundColor: 'rgba(255,102,0,0.05)' }}>
                <CardContent sx={{ p: 3 }}>
